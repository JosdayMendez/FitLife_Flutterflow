...
class ChatsListRecord extends FirestoreRecord {
  ...
  // "userNotified" field.
  List<DocumentReference>? _userNotified;
  List<DocumentReference> get userNotified => _userNotified ?? const [];
  bool hasUserNotified() => _userNotified != null;
  ...
  void _initializeFields() {
    ...
    _userNotified = getDataList(snapshotData['userNotified']);
...
class ChatsListRecordDocumentEquality implements Equality<ChatsListRecord> {
  ...
  bool equals(ChatsListRecord? e1, ChatsListRecord? e2) {
    ...
    return e1?.chatName == e2?.chatName &&
        ...
        listEquality.equals(e1?.userNotified, e2?.userNotified) &&
