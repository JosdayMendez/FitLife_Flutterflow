              ...
              child: Padding(
                ...
                child: FlutterFlowDropDown<String>(
                  controller: _model.ddMealTypeValueController ??=
                    ...
                    _model.ddMealTypeValue ??= widget.meal?.mealType,
                  ),
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.meal!.reference
                            .update(createMealsRecordData(
                          name: _model.txtMealNameTextController.text,
                          preparation: _model.txtPreparationTextController.text,
                          mealType: _model.ddMealTypeValue,
                          ingredients: _model.txtIngredientsTextController.text,
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              ...
                              content: const Text('Meal edited correctly!'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
